...
public Q_SLOTS: // METHODS
    ...
    * When True, many of the Kitty methods alter their behavior.
    */
...
private:
    /**
    * Constructor.
    * Note: Applications do not create instances of Kitty.
    * Instead create KSpeechInterface object.  See @ref programming.
    */
    Kitty(QObject *parent=0);

    KittyPrivate *d;
    static Kitty *m_instance;
