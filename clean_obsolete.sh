...
$LIBTOOL --mode=uninstall $PREFIX/lib/kde4/libktts
...
$LIBTOOL --mode=uninstall $PREFIX/lib/kde4/kcm_kttsmgr
...
$LIBTOOL --mode=uninstall $PREFIX/lib/kde4/libkttsjobmgr
...
$LIBTOOL --mode=uninstall $PREFIX/lib/kde4/libfestivalplugin
$LIBTOOL --mode=uninstall $PREFIX/lib/kde4/libfestivalintplugin
$LIBTOOL --mode=uninstall $PREFIX/lib/kde4/libcommandplugin
$LIBTOOL --mode=uninstall $PREFIX/lib/kde4/libhadifixplugin
$LIBTOOL --mode=uninstall $PREFIX/lib/kde4/libfliteplugin
$LIBTOOL --mode=uninstall $PREFIX/lib/kde4/libeposkttsdplugin
$LIBTOOL --mode=uninstall $PREFIX/lib/kde4/libfreettsplugin
...
$LIBTOOL --mode=uninstall /lib/kde4/libhadifaxplugin

# Clean up the library cache.

$LIBTOOL --mode=finish -n $PREFIX/lib
$LIBTOOL --mode=finish -n $PREFIX/lib/kde4/
